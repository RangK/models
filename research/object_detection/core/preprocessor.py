...
from tensorflow.python.framework.versions import VERSION as __tf_version__
...
tf_versions = [int(v) for v in __tf_version__.split(".")]
...
def resize_to_range(image,
  ...
  def _resize_landscape_image(image):
    ...
    if tf_versions[0] > 1 or tf_versions[1] > 9:
